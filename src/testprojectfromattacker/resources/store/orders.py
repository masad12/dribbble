...
class OrdersResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> OrdersResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/masad12/dribbble#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> OrdersResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/masad12/dribbble#with_streaming_response
        """
