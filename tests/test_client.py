...
from testprojectfromattacker import Testprojectfromattacker, APIResponseValidationError, AsyncTestprojectfromattacker
from testprojectfromattacker._types import Omit
from testprojectfromattacker._models import BaseModel, FinalRequestOptions
from testprojectfromattacker._exceptions import (
    APIStatusError,
    APITimeoutError,
    APIResponseValidationError,
    TestprojectfromattackerError,
)
from testprojectfromattacker._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Testprojectfromattacker | AsyncTestprojectfromattacker) -> int:
...
class TestTestprojectfromattacker:
    client = Testprojectfromattacker(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_copy_default_headers(self) -> None:
        client = Testprojectfromattacker(
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "testprojectfromattacker/_legacy_response.py",
                        "testprojectfromattacker/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "testprojectfromattacker/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = Testprojectfromattacker(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TestprojectfromattackerError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = Testprojectfromattacker(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Testprojectfromattacker) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TESTPROJECTFROMATTACKER_BASE_URL="http://localhost:5000/from/env"):
            client = Testprojectfromattacker(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Testprojectfromattacker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Testprojectfromattacker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Testprojectfromattacker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Testprojectfromattacker(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Testprojectfromattacker(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("testprojectfromattacker._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Testprojectfromattacker) -> None:
    ...
    @mock.patch("testprojectfromattacker._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Testprojectfromattacker) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Testprojectfromattacker, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncTestprojectfromattacker:
    client = AsyncTestprojectfromattacker(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_copy_default_headers(self) -> None:
        client = AsyncTestprojectfromattacker(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        assert client.default_headers["X-Foo"] == "bar"
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncTestprojectfromattacker(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTestprojectfromattacker) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TESTPROJECTFROMATTACKER_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTestprojectfromattacker(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTestprojectfromattacker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTestprojectfromattacker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTestprojectfromattacker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTestprojectfromattacker(
        ...
        client = AsyncTestprojectfromattacker(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncTestprojectfromattacker
    ) -> None:
        respx_mock.get("/store/inventory").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncTestprojectfromattacker,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTestprojectfromattacker, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from testprojectfromattacker._utils import asyncify
        from testprojectfromattacker._base_client import get_platform
