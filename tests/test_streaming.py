...
from testprojectfromattacker._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(sync: bool, client: Testprojectfromattacker, async_client: AsyncTestprojectfromattacker) -> None:
...
async def test_data_missing_event(
    sync: bool, client: Testprojectfromattacker, async_client: AsyncTestprojectfromattacker
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"
